            ...
            try:
                ...
                with st.spinner("...AI는 부정확한 답변을 제공할 수 있습니다..."):
                    ...
                    **등가직사각형 응력블록 계수는 아래 값 따른다.**
                    ...
                    - 단계제목, 설명1, 설명2, 수식1, 수식2 와 같은 순서를 지키며, 각각 은 한 줄씩 줄바꿈하여 가독성을 높인다.
                    - <2단계> **단계 제목**...
                    ...
                    **[답변 형식 예시]**
                    [핵심개념]
                    철근콘크리트 복철근 직사각형보의 설계강도는 KDS 14 20 20에 따른 단면 내 우력의 평형 조건과 변형률 적합 조건을 이용하여 산정한다. 
                    압축연단 콘크리트의 극한변형률과 각 철근의 항복요부, 강도감소계수를 검토해야 한다.
                    ...
                    [주의사항]
                    - 답변 형식 가이드라인을 반드시 지키고, 답변 형식 예시를 반드시 참고할 것.
                    - 계산 과정에서 변형률의 경우는 유효숫자 3자리까지 표현(반올림)으로 제한한다.
                    - 계산 과정에서 길이의 경우는 소수점 아래 2자리까지 표현(반올림)으로 제한한다.
                    - 핵심개념, 풀이, 수식, 값에 대해서만 답변을 제공한다.
                    - 반드시 '사용자 요청 사항 반영', '반올림'과 같은 미사여구는 답변에서 제외한다.
